...
This slide shows the detailed research items.

The study is organized into three major areas.
...
Customization platforms and solutions
Functional safety requirements
Ethical and safety measures, including guardrails, prompt controls, and behavioral tuning
AI Models

We would like to clarify:

Model names and categories, such as LLMs and SLMs
Model architectures, such as Transformers
Supported frameworks and hardware platforms
Slide 4 (Result Format)

This slide shows the expected result format.

In addition to detailed research findings, I would like the results to be organized into a summary table.

The summary table will help us compare available options and support future decision-making.

Slide 5 (AI Agent Examples)

Here are a few examples that align with this research.

On the left is NIO's in-vehicle AI assistant, NOMI.

NOMI provides a natural and interactive communication experience for drivers.

On the right is Mpathic.ai.

Mpathic.ai provides a platform for training, evaluating, and tuning conversational AI models and agents.

Slide 6 (AI Model Example)

This slide shows an example of an AI model used on embedded platforms.

One example is Google Gemma running on MediaTek platforms.

I believe that most AI agents are expected to operate on edge devices.

Therefore, we would like to identify, as clearly as possible, which AI models are being used by edge-based AI agents.
